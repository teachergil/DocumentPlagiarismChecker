...
{
    /// <summary>
    /// The Word Counter pepe @gilsimjo Comparator @gilsimjo asdfZXcZXCZXCasdfreadssdfgsdfg a pair of files and counts how many words and how many times appear on each file, and then calculates
